namespace Textile.Core.Entities.Models.Response.Customers
{
    ...
    public class CustomerResponse
    {
        ...
        public Textile.Core.Entities.Models.Response.Agents.AgentTableResponse? CustomerAgentObj { get; set; }
